...
void main() {
  ...
  // Conversão de Temperatura: Crie um programa que permita ao usuário converter temperaturas de Celsius para Fahrenheit e vice-versa.
  print("Informe a temperatura que deseja converter: ");
  String temperatura = stdin.readLineSync()!;
  print("Informe |C| para Celsius ou |F| para Fahrenheit: ");
  String dadoTemp = stdin.readLineSync()!.toLowerCase();
  double temp = double.parse(temperatura);

  if(dadoTemp == 'f') {
    double tempC = (temp - 32) / 1.8;
    String valorC = tempC.toStringAsFixed(2);
    print("A temperatura informada em Celsius é: $valorC");
  } else {
    double tempF = (temp * 1.8) + 32;
    String valorF = tempF.toStringAsFixed(2);
    print("A temperatura informada em Fahrenheit é: $valorF");
  }
